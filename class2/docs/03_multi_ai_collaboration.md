...
本單元將以一個真實且極具挑戰性的 **「政府大型展覽活動總包工程標案 (台南玩具展總包為例)」** 為背景，展示 Pro 等級 AI Agent 如何自主運行端到端的工作流，解決複雜的技術對帳與管理衝突。
...
* **🌐 外部招標硬性要求 (Client Compliance)**：
  ...
  2. 財務資格：必須提供 300 萬元以上之「政府大型活動展會/總包專案」歷史實績，且必須附帶客戶簽章的驗收公文。
...
| **歷史專案實績** | 金額 > 300 萬且公文齊全 | 繁星智慧展覽專案 (350 萬，公文完整) | 🟢 綠燈 | 啟動誠信紅線防禦，主動排除無驗收單的鼎盛展區集體承包案。 |
