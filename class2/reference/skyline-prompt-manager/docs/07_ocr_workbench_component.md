# Skyline OCR Workbench Component Design

## 1. Core Positioning

Skyline OCR Workbench is an independent data-conversion component hosted outside this Prompt Manager package.

It is not a side panel inside Skyline Prompt Manager, and it is no longer maintained as a local `ocr.html` in this package. Prompt Manager opens the public OCR tool:

```text
https://__Skyline_TAIWAN_IO__/ai-ocr-demo/
```
...
### Skyline Prompt Manager `index.html`
...
### Skyline OCR Workbench External Page
...
The first version should not build a complex post-processing workflow. Users can copy the result back to Prompt Manager, ChatGPT, Gemini, NotebookLM, or another Skyline tool.
...
- Prompt Manager opens `https://__Skyline_TAIWAN_IO__/ai-ocr-demo/`
...
- open `https://__Skyline_TAIWAN_IO__/ai-ocr-demo/`
...
> OCR Workbench is an external Skyline data-conversion component: Prompt Manager links to it instead of embedding OCR logic locally.
