...
本文用途：把 `AI_Teach_Classroom` 與 `__Skyline_TAIWAN__/aiocr-pro01` 裡的 Gemini OCR 模型路由、影像處理方式、資料保存邊界，整理成 Skyline Prompt Manager v0.3 的參考設計。

參考來源：

- GitHub repo: https://github.com/__Skyline_TAIWAN__/aiocr-pro01
...
- 本機參考：`/Users/force/AI-CodeX/AI_Teach_Classroom/skyline_ocr_server_node/docs`
