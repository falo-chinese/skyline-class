# Skyline Prompt Manager v1.01 Release Notes
...
| --- | --- |
| Version | v1.01 |
| Brand | Skyline x Force Cheng |
| Release Date | 2026/6/1 |
| Geo | Taiwan |
| Product Line | Skyline Prompt |
...
> Skyline Prompt Manager v1.01 是一個可教學、可展示、可安裝的 Prompt Asset Management PWA。
...
- `service-worker.js` cache name 更新為 `skyline-prompt-manager-v101-20260601-release`。
- 編修模式中，文字區下方加入「即時預覽」，顯示變數代入後結果。

### 2.2 備註層

- 主畫面品牌區顯示 `v1.01 · Skyline x Force Cheng · 2026/6/1`。
- PWA 狀態卡顯示版本備註。
...
```text
Skyline Prompt Manager v1.01 | Skyline x Force Cheng | 2026/6/1 | Taiwan | Prompt Asset Management PWA
```
...
7. zip 備份已放入 `backup/`。
8. GitHub repo 已推送到 `__Skyline_TAIWAN__/prompt-demo`。
