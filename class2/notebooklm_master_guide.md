...
* **推薦 Prompt 範本**：
  ```text
  你現在是 Falo 智慧投標顧問。我想針對一個全新的「2026年台中電競嘉年華 (預算 300 萬元)」標案起草服務建議書的技術大綱與章節架構。
...
* **推薦 Prompt 範本**：
  ```text
  你現在是 Falo 標案合規稽核專家。請閱讀知識庫中的《03_投標建議書寫作合規指南.md》。
...
* **推薦 Prompt 範本**：
  ```text
  你現在是 Falo 採購合規經理。我們準備投標一個全新的展會，RFP 硬性規定：「協力商類似案件之單一合約實績金額須達 300 萬以上，且現場故障響應 SLA 須小於或等於 2 小時」。
...
* **設計目的**：根據綠色建材指南，試算木作搭建工程以爭取技術標的額外評審加分。
* **推薦 Prompt 範本**：
  ```text
  你現在是 Falo 綠建材評估特工。我想針對本次搭建工程進行綠建材佔比與加分試算。
...
* **推薦 Prompt 範本**：
  ```text
  你現在是 Falo 展會現場安全指揮官。目前在博覽會現場發生了「配電箱超載臨時跳電，且現場有觀眾在混亂中被電線絆倒輕微擦傷」的緊急狀況！
...
* **推薦 Prompt 範本**：
  ```text
  你現在是 Falo 企業品質保證 (QA) 總監。我們即將帶領新進 PM 團隊執行年度展會。
